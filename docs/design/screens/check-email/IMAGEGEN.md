...
Screen: `check-email`; initial state: `default`; surface: planned route. Compose one readable first viewport at 390x844 browser-content proportions. Other states (resending, expired, rate-limited, error, offline) require separate images when applicable.
