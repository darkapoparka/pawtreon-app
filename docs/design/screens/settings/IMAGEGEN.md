...
Screen: `settings`; initial state: `default`; surface: planned route. Compose one readable first viewport at 390x844 browser-content proportions. Other states (loading, empty, error, offline, permission-denied) require separate images when applicable.
