...
Screen: `create-story`; initial state: `default`; surface: planned route. Compose one readable first viewport at 390x844 browser-content proportions. Other states (uploading, upload-failed, validation-error, save-conflict, offline) require separate images when applicable.
