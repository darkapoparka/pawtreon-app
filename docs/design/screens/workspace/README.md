...
**Planned path:** `/workspaces/[workspaceId]`
...
1. Acting identity switcher and role
2. Cases/campaigns needing action; drafts
3. Review and payout readiness without fake metrics
4. Recent updates and tasks
...
- **Manage fundraisers** -> [manage-list](../manage-list/README.md)
- **Create new** -> [create](../create/README.md)
- **Verification** -> [verification](../verification/README.md)
- **Payout settings** -> [payouts](../payouts/README.md)
- **Team members** -> [members](../members/README.md)
- **Workspace settings** -> [workspace-settings](../workspace-settings/README.md)
...
[Existing low-fidelity wireframe](../../wireframes/index.html#workspace) · [Individual image brief](IMAGEGEN.md)
