...
- **Open campaign** -> [campaign](../campaign-detail/README.md)
- **Create a campaign** -> [create](../create/README.md)
...
[Existing low-fidelity wireframe](../../wireframes/index.html#campaigns) · [Individual image brief](IMAGEGEN.md)
