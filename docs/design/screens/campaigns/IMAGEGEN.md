# Image brief: Community campaigns
...
Screen: `campaigns`; initial state: `default`; surface: planned route. Compose one readable first viewport at 390x844 browser-content proportions. Other states (loading, empty, error, offline, permission-denied) require separate images when applicable.
...
1. Search campaigns
2. Need and location filters
3. Featured winter initiative
4. Campaign cards with organizer, goal and status
