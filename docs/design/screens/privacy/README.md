...
- **Terms of use** -> [terms](../terms/README.md)
- **Account preferences** -> [settings](../settings/README.md)
...
[Existing low-fidelity wireframe](../../wireframes/index.html#privacy) · [Individual image brief](IMAGEGEN.md)
