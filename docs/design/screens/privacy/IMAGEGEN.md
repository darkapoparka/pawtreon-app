...
Screen: `privacy`; initial state: `default`; surface: planned route. Compose one readable first viewport at 390x844 browser-content proportions. Other states (loading, empty, error, offline, permission-denied) require separate images when applicable.
...
1. Data categories, purposes and lawful-basis review
2. Private evidence, donor privacy and public location precision
3. Processors, retention, rights and contact details
4. Owner/legal review required before launch
