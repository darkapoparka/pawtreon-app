...
**Screen ID:** `review-queue`

**Surface:** planned route

**Planned path:** `/admin/reviews`

**Access:** platform reviewer; MFA/recent auth
...
1. Submitted cases/campaigns and organizer evidence
2. Assigned/unassigned filters and age
3. Private evidence accessible only by role
4. No public admin navigation
...
- **Open review** -> [review-detail](../review-detail/README.md)
- **Reported content** -> [admin-reports](../admin-reports/README.md)
...
[Existing low-fidelity wireframe](../../wireframes/index.html#review-queue) · [Individual image brief](IMAGEGEN.md)
