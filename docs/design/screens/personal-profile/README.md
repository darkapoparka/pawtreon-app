...
1. Avatar, name and approximate service area
2. Personal organizer label; accurate verification scope
3. Active cases and campaigns
4. Past outcomes and public updates
...
[Existing low-fidelity wireframe](../../wireframes/index.html#person) · [Individual image brief](IMAGEGEN.md)
