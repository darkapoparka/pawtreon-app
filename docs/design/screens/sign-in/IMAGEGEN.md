...
Screen: `sign-in`; initial state: `default`; surface: planned route. Compose one readable first viewport at 390x844 browser-content proportions. Other states (submitting, invalid-email, rate-limited, error, offline) require separate images when applicable.
