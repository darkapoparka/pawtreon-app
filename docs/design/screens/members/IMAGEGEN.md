...
Screen: `members`; initial state: `default`; surface: planned route. Compose one readable first viewport at 390x844 browser-content proportions. Other states (pending-invite, expired, last-owner-blocked, permission-denied, error) require separate images when applicable.
