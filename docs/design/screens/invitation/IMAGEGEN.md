# Image brief: Join a Pawtreon team
...
Screen: `invitation`; initial state: `default`; surface: planned route. Compose one readable first viewport at 390x844 browser-content proportions. Other states (expired, revoked, already-accepted, wrong-account, error) require separate images when applicable.
