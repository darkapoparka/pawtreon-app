...
**Screen ID:** `create-basics`

**Surface:** planned route

**Planned path:** `/create/[kind]/[draftId]/basics`
...
1. Step 1 of 4; acting identity and kind
2. Animal/group name or campaign title
3. Species, need and coarse location
4. No automatic GPS publication
...
- **Save and continue** -> [create-story](../create-story/README.md)
- **Save draft and exit** -> [workspace](../workspace/README.md)
- **Back:** [create](../create/README.md)
...
| Species | select | Cats\|Dogs\|Other\|Multiple species |
| Need | select | Medical\|Food\|Shelter\|Foster |
| City or neighborhood | text | Not specified |
...
[Existing low-fidelity wireframe](../../wireframes/index.html#create-basics) · [Individual image brief](IMAGEGEN.md)
