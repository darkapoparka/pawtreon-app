...
- **Open saved case** -> [case](../case-detail/README.md)
- **Open saved campaign** -> [campaign](../campaign-detail/README.md)
...
[Existing low-fidelity wireframe](../../wireframes/index.html#saved) · [Individual image brief](IMAGEGEN.md)
